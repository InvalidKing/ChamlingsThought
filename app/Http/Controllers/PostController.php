...
class PostController extends Controller
{
    ...
    $posts->save();
    return redirect('/home')->with('response','Post Added Sucessfully');
    ...
    $posts->update();
    return redirect('/home')->with('response','Post Edited Sucessfully');


    }
    public function deletePost($post_id){
        Post::where('id',$post_id)->delete();
        return redirect('/home')->with('response','Post Deleted Sucessfully');
    ...
    public function dislike($id){
        ...
        public function comment(Request $request ,$post_id){
            ...
            $comment->save();
            return redirect("/view/{$post_id}")->with('response','Comment Added Sucessfully');;
